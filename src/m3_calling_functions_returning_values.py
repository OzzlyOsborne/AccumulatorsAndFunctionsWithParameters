...
def test_sum_of_digits():
    ...
    #Test 3:
    expected3 = 27
    answer3 = sum_of_digits(999)
    print('Test 2 expected', expected3)
    print('       actual:',  answer3)


    #Test 4:
    expected4 = 45
    answer4 = sum_of_digits(123456789)
    print('Test 2 expected', expected4)
...
def test_digits_in_power():
    ...
    # Test 2
    expected = 1
    answer = digits_in_power(1, 13)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3
    expected = 36
    answer = digits_in_power(123, 3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4
    expected = 22
    answer = digits_in_power(13, 4)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
...
def test_fancy_sums_of_digits():
    ...
    # Test 2
    expected = 104985
    answer = fancy_sums_of_digits(24)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
