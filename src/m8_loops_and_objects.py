...
def draw_circles1():
    ...
    window = rg.RoseWindow(400,400,'DrawCircles')
...
def draw_circles2():
    ...
    print('--------------------------------------------------')
    window = rg.RoseWindow(400,400,'DrawCircles2')
    for k in range(18):
...
def draw_circles3():
    ...
    print('--------------------------------------------------')
    window = rg.RoseWindow(300,300,'DrawCircles3')
    for k in range (100):
...
def draw_cosines_and_sines():
    ...
    window = rg.RoseWindow(400,400,'DrawCosinesAndSines')
    for k in range(101):
